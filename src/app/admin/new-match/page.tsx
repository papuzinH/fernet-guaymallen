...
import ModernAdminNewMatch from '@/components/ui/modern-admin-new-match';
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {[...Array(3)].map((_, i) => (
          <motion.div
            ...
            style={{
              background: `radial-gradient(circle, rgba(${i === 0 ? '16, 185, 129' : i === 1 ? '139, 92, 246' : '59, 130, 246'}, 0.3), transparent)`,
              left: `${20 + i * 30}%`,
              top: `${10 + i * 20}%`,
            }}
            animate={{
