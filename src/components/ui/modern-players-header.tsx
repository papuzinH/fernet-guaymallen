...
interface ModernPlayersHeaderProps {
  className?: string;
}

export const ModernPlayersHeader: React.FC<ModernPlayersHeaderProps> = ({
  className
}) => {
  return (
    <motion.section
    ...
    >
      ...
      <div className="absolute inset-0">
        {/* Gradient Overlay */}
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-blue-900/20 via-green-900/20 to-purple-900/20"
          animate={{
            background: [
              "linear-gradient(45deg, rgba(59, 130, 246, 0.1), rgba(16, 185, 129, 0.1), rgba(139, 92, 246, 0.1))",
              "linear-gradient(225deg, rgba(139, 92, 246, 0.1), rgba(59, 130, 246, 0.1), rgba(245, 158, 11, 0.1))",
              "linear-gradient(45deg, rgba(245, 158, 11, 0.1), rgba(239, 68, 68, 0.1), rgba(59, 130, 246, 0.1))",
              "linear-gradient(45deg, rgba(59, 130, 246, 0.1), rgba(16, 185, 129, 0.1), rgba(139, 92, 246, 0.1))"
            ]
          }}
          transition={{
      ...
      <div className="relative z-10">
        ...
        >
          Conoce a los jugadores del club y sus estadísticas
        </motion.p>
...
export default ModernPlayersHeader;
